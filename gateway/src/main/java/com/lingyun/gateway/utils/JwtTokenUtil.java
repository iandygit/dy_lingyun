package com.lingyun.gateway.utils;
...
public class JwtTokenUtil {
    ...
    public static String createJWT(String id, String subject, Long ttlMillis) {
        ...
        if (ttlMillis == null) {
            ttlMillis = JwtTokenUtil.JWT_TTL;
        }
    ...
    public static SecretKey generalKey() {
        byte[] encodedKey = Base64.getEncoder().encode(JwtTokenUtil.JWT_KEY.getBytes());
