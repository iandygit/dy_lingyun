package com.lingyun.core.config;



public class KeyConfig {
    //private static final String BASE_FILE_PATH = "/opt/KeyStore";
    ...
    //获取keystore所需的密码
    public static final String KEYSTORE_PASSWORD = "lingyun2020";
    //获取私钥所需密码
    public static final String KEY_PASSWORD = "json_jack&2";
}
