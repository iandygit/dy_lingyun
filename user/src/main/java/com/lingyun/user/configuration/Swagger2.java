...
public class Swagger2 extends AbstractSwagger2  {
    ...
    public Docket webSiteApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.lingyun.user"))
                //.paths(PathSelectors.ant("/com/magic/controller/product/**"))
                .paths(PathSelectors.any())
                .build();
    }
    private ApiInfo apiInfo() {
        Contact contact = new Contact("用户中心管理.", "http://www.51gkp.com", "magic_sys@lasergroup.cn");
        return new ApiInfoBuilder()
                .title("用户中心管理 API")
                .description("用户中心管理api")
