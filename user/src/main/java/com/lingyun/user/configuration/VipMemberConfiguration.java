...
@Configuration
@EnableJpaRepositories(basePackages="com.lingyun.user.dao",entityManagerFactoryRef = "magicVipMemberEntityManager",transactionManagerRef="magicVipMemberTransactionManager")
@EntityScan({"com.lingyun.user.entity"})
public class VipMemberConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean magicEntityManager() {
        ...
        em.setPackagesToScan(
                new String[] { "com.lingyun.user.entity" });
